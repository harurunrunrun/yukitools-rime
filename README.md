...
python -m build
python -m pip install --force-reinstall dist/yukitools_rime-0.1.6-py3-none-any.whl
yukitools-rime --version
yukitools-rime --help
~~~
...
git pull --ff-only
python -m build
python -m pip install --upgrade --force-reinstall dist/yukitools_rime-0.1.6-py3-none-any.whl
yukitools-rime --version
~~~
